...
description: Generates ad creatives for Meta and Google campaigns — ad copy (headlines, descriptions, CTAs) using proven copywriting frameworks, and image prompts for AI generation. Produces multiple A/B variants per brief.
metadata:
  openclaw:
    emoji: "\U0001F3A8"
    requires:
