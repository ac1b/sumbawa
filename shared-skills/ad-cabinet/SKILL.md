---
name: ad-cabinet
description: Manages Meta Ads and Google Ads campaigns — creates, edits, pauses, scales campaigns. Handles audiences, budgets, bidding, and ad creative uploads through platform APIs.
metadata:
  openclaw:
    emoji: "\U0001F4CB"
    requires:
...
- Credentials in env: `GOOGLE_ADS_CLIENT_ID`, `GOOGLE_ADS_CLIENT_SECRET`, `GOOGLE_ADS_REFRESH_TOKEN`, `GOOGLE_ADS_DEVELOPER_TOKEN`, `GOOGLE_ADS_CUSTOMER_ID`

**API Base**: `https://googleads.googleapis.com/v18`
...
1. Choose template from campaign-templates (or custom based on ad-spy insights)
2. Prepare creative assets (coordinate with creative-generator skill)
3. Define audience (from audiences.md or custom)
4. Create campaign via API — **ALWAYS PAUSED**
5. Log action to action-log.md
6. Notify ac1b: "Campaign [name] created and paused. Ready for review."
7. Wait for approval before activating
