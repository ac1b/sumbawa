...
description: Manages the full advertising funnel — from cold awareness to warm retargeting to hot conversion. Automates audience building, funnel stage transitions, and messaging sequences across Meta and Google.
metadata:
  openclaw:
    emoji: "\U0001F3AF"
    requires:
